...
class AdminInternshipCreateScreen extends ConsumerStatefulWidget {
  const AdminInternshipCreateScreen({super.key});
  @override
  ConsumerState<AdminInternshipCreateScreen> createState() =>
      _AdminInternshipCreateScreenState();
}

class _AdminInternshipCreateScreenState
    extends ConsumerState<AdminInternshipCreateScreen> {
  ...
  Future<void> _save() async {
    ...
    if (_startDate == null ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          ...
          content: Text(
              'Please select start, end, registration start and registration end dates')));
      return;
    }
