...
class StudentNotificationScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<StudentNotificationScreen> createState() =>
...
class _StudentNotificationScreenState
  ...
  Future<void> _fetch() async {
    ...
    try {
      final result = await StudentNotificationService.getAll();
              ...
              : _notifications.isEmpty
                  ? Center(
                      child: Column(
                          ...
                          Text(
                              'You\'ll see notifications about registrations,\npayments, certificates and course updates here.',
